...
export const SideBar: Component<{ children: JSX.Element }> = (props) => {
  return (
    <>
              ...
              <ul class="space-y-1">
                ...
                <li>
                  ...
                  >
                    ...
                    Calendar{" "}
                    <span class="ms-auto py-0.5 px-1.5 inline-flex items-center gap-x-1.5 text-xs bg-gray-200 text-gray-800 rounded-full dark:bg-neutral-600 dark:text-neutral-200">
                      New
                    </span>
                  </a>
                </li>
      ...
      <div class="py-20 px-80">{props.children}</div>
      {/* End Sidebar */}
    </>
  );
};
