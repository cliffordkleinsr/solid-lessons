...
export default function Nav() {
  ...
  return (
    <header class="backdrop-blur-md sticky top-0 z-30">
              ...
              <ul class="flex items-center gap-6 text-sm">
                <li>
                  <A
                    ...
                    classList={{
                      "text-teal-600 hover:text-teal-600/75": active("/about"),
                    }}
                    href="/about"
                  >
                    About
                ...
                <li>
                  <A
                    class="text-gray-500 transition hover:text-gray-500/75"
                    classList={{
                      "text-teal-600 hover:text-teal-600/75": active("/users"),
                    }}
                    href="/users"
                  >
                    Data Loading
                ...
                <Dropdown name="Animations">
                  ...
                  <li>
                    <A
                      class="text-gray-500 transition hover:text-gray-500/75"
                      href="/animations/scrollhijack"
                    >
                      AnimeJs ScrollHijack
                    </A>
                  </li>
                </Dropdown>
